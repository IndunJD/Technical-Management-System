...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<p class="my-5"><img src="https://s3.amazonaws.com/libapps/customers/2221/images/ask_us.png" alt="logo" class="img-fluid d-block mx-auto"/></p>
	...
	<div class="row">
		<div class="col-sm-12">
			<ul class="nav nav-tabs">
				<li ><a data-toggle="tab" href="#tab1" aria-selected="true" class="active"><b>For Service Providers</b></a></li>
				<li><a data-toggle="tab" href="#tab2" aria-selected="false"><b>For customers</b></a></li>
			</ul>
		</div>
	</div>
	<div class="row">
					...
					<div class="accordion">
						<div class="card">
							...
							<div id="collapseOne" class="collapse" aria-labelledby="infraOne" data-parent="#accordion">
								<div class="card-body">
								You should select the registration tab in the top bar in order to get directed to sign up.If you already have an account, you can Log in.
								</div>
							</div>
						</div><!-- close card-->
						<div class="card">
							<div class="card-header" id="infraTwo">
								<a href="#collapseTwo" class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
								  <p class="mb-0">How should i add my service?</p>
								</a>
							</div>
							<div id="collapseTwo" class="collapse" aria-labelledby="infraTwo" data-parent="#accordion">
								<div class="card-body">
								You should sign up through registration page in order to add your service. once you are signed in, you can log in to our page to add your service. you will get a form to fill up in order to add your service
						...
						<div class="card">
							<div class="card-header" id="infraThree">
								<a href="#collapseThree" class="collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
									<p class="mb-0">Can i delete or edit my advertisement?</p>
								</a>
							</div>
							<div id="collapseThree" class="collapse" aria-labelledby="infraThree" data-parent="#accordion">
								<div class="card-body">
								Yes. you can delete and also edit your advertisement by logging in.
</div>
							</div>
						</div><!-- card-->
					</div><!-- accordion-->
					...
					<div class="card">
						<div class="card-header" id="aboutOne">
							<a href="#collapseFour"   data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseOne">
								<p class="mb-0">What type of services do you provide?</p>
							</a>
						</div>
						<div id="collapseFour" class="collapse" aria-labelledby="aboutOne" data-parent="#accordion">
							<div class="card-body">
							we provide all kinds of services including:
                                                        <ul><li> House Construction</li>
                                                        <li> Flooring</li>
                                                        <li> Plumbing</li>
                                                        <li> Furniture</li>
					...
					<div class="card">
						<div class="card-header" id="aboutTwo">
							<a href="#collapseFive" class="collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseTwo">
							  <p class="mb-0">How can I find service providers?</p>
							</a>
						</div>
						<div id="collapseFive" class="collapse" aria-labelledby="aboutTwo" data-parent="#accordion">
							<div class="card-body">
							You can find our service providers in the advertisements section.</div>
						</div>
					</div>
					<div class="card">
						<div class="card-header" id="aboutThree">
							<a href="#collapseSix" class="collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseThree">
							  <p class="mb-0"> Can I contact the service providers directly? </p>
							</a>
						</div>
						<div id="collapseSix" class="collapse" aria-labelledby="aboutThree" data-parent="#accordion">
							<div class="card-body">
							Yes, You can find their contact details in the advertisements section. 
							</div>
						</div>
					</div>
				</div><!-- accordion-->
